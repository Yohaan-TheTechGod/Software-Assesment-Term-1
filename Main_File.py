...
def open_main_page(root):
    ...
    image_path=PhotoImage(file="/Users/yohaan_thetechgod/Desktop/Year 11 Stuff/Projects/Software Engineering/Software Assesment 1/Periodic table background.png")
    ...
    tk.Button(root, text="Exit", command=root.quit, width=15).pack(pady=10)
